...
public class ManageInventoryController {
    ...
    private void loadTable() {
        try {
            ...
            detailsTabel.getItems().addAll(inventoryModel.getAllInventories());
        } catch (Exception e) {
    ...
    void navigateSave(ActionEvent event) {
        try {
            ...
            String response = inventoryModel.saveInventory(dto);
    ...
    void navigateUpdate(ActionEvent event) {
        try {
            ...
            String response = inventoryModel.updateInventory(dto);
            new Alert(Alert.AlertType.INFORMATION, response).show();
            loadTable();
            navigateReset(event);
        } catch (Exception e) {
    ...
    void navigateDelete(ActionEvent event) {
        try {
            String response = inventoryModel.deleteInventory(inventoryID.getText());
            new Alert(Alert.AlertType.INFORMATION, response).show();
            loadTable();
            navigateReset(event);
        } catch (Exception e) {
