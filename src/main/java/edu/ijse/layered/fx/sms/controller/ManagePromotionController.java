...
public class ManagePromotionController {
    ...
    final private PromotionModel promotionModel = new PromotionModel();
    ...
    public void loadTable() {
        try {
            ...
            promotionTable.getItems().addAll(promotionModel.getAllPromotions());
        } catch (Exception e) {
    ...
    void navigateDelete(ActionEvent event) {
        try {
            String res = promotionModel.deletePromotion(promoteIDTxt.getText());
            loadTable();
            navigateReset(event);
    ...
    void navigateSave(ActionEvent event) {
        try {
            ...
            String res = promotionModel.savePromotion(promotionDTO);
            new Alert(Alert.AlertType.INFORMATION, res).show();
            loadTable();
            navigateReset(event);
        } catch (Exception e) {
    ...
    void navigateUpdate(ActionEvent event) {
        try {
            ...
            String res = promotionModel.updatePromotion(promotionDTO);
            new Alert(Alert.AlertType.INFORMATION, res).show();
            loadTable();
            navigateReset(event);
        } catch (Exception e) {
